...
`docs/SETUP.md`를 참고하세요. 카카오 개발자 등록, GitHub 시크릿, Pages 설정 순서로 정리되어 있습니다.

## 기술 스택

Astro 7 (정적 빌드, 빌드 시 WebP 변환) · Pretendard + Gowun Dodum · PhotoSwipe · Kakao Maps/Share JS SDK v2 · GitHub Actions → GitHub Pages
